...
<template>
  <div class="container">
    <div class="row" id="appWeather">
      <section class="col-12 weatherInfo">
        <h1>臺灣<br>動態即時天氣地圖</h1>
        <div class="weatherTitle">
          <p>** 請將箭頭指標滑到臺灣地圖中喔～ **</p>
        </div>
        <div class="weatherDesc" v-for="item in newsList">
          <h2>{{ item.location }}</h2>
          <h4 class="descText1">{{ item.low }}{{ item.high }}</h4>
          <h4 class="descText2">{{ item.rain }}</h4>
          <h2>{{ item.weather }}</h2>
        </div>
        <!-- <div class="weatherDesc" v-if="showNew">
              <h2>{{ showNew.location }}</h2>
              <h4 class="descText1">{{ showNew.low }}{{ showNew.high }}</h4>
              <h4 class="descText2">{{ showNew.rain }}</h4>
              <h2>{{ showNew.weather }}</h2>
            </div> -->
      </section>
      <section class="col-12 taiwanMap">
        <svg baseprofile="tiny" fill="#7c7c7c" height="1295" stroke="#ffffff" stroke-linecap="round"
          stroke-linejoin="round" stroke-width="2" version="1.2" viewbox="0 0 1000 1295"
          ...
          <path
            ...
            id="TWN1156" name="Kaohsiung City" data-name-zh="高雄市">
          </path>
          <path
            ...
            id="TWN1158" name="Pingtung" data-name-zh="屏東縣">
          </path>
          <path
            ...
            id="TWN1160" name="Tainan City" data-name-zh="臺南市">
          </path>
          <path
            ...
            id="TWN1161" name="Hsinchu City" data-name-zh="新竹市">
          </path>
          <path
            ...
            id="TWN1162" name="Hsinchu" data-name-zh="新竹縣">
          </path>
          <path
            ...
            id="TWN1163" name="Yilan" data-name-zh="宜蘭縣">
          </path>
          <path
            ...
            id="TWN1164" name="Keelung City" data-name-zh="基隆市">
          </path>
          <path
            ...
            id="TWN1165" name="Miaoli" data-name-zh="苗栗縣">
          </path>
          <path
            ...
            id="TWN1166" name="Taipei City" data-name-zh="臺北市">
          </path>
          <path
            ...
            id="TWN1167" name="New Taipei City" data-name-zh="新北市">
          </path>
          <path
            ...
            id="TWN1168" name="Taoyuan" data-name-zh="桃園市">
          </path>
          <path
            ...
            id="TWN1169" name="Changhua" data-name-zh="彰化縣">
          </path>
          <path
            ...
            id="TWN1170" name="Chiayi" data-name-zh="嘉義縣">
          </path>
          <path
            ...
            id="TWN1171" name="Chiayi City" data-name-zh="嘉義市">
          </path>
          <path
            ...
            id="TWN1172" name="Hualien" data-name-zh="花蓮縣">
          </path>
          <path
            ...
            id="TWN1173" name="Nantou" data-name-zh="南投縣">
          </path>
          <path
            ...
            id="TWN1174" name="Taichung City" data-name-zh="臺中市">
          </path>
          <path
            ...
            id="TWN1176" name="Yunlin" data-name-zh="雲林縣">
          </path>
          <path
            ...
            id="TWN1177" name="Taitung" data-name-zh="臺東縣">
          </path>
          <path
            ...
            id="TWN3414" name="Penghu" data-name-zh="澎湖縣">
          </path>
          <path
            ...
            id="TWN3415" name="Kinmen" data-name-zh="金門縣">
          </path>
          <path
            ...
            id="TWN5128" name="Lienchiang" data-name-zh="連江縣">
          </path>
...
.weatherInfo h1 {
  font-weight: bold;
  color: white;
  text-shadow: 2px 2px 8px rgb(200, 200, 245);
}

.weatherTitle {
  text-align: right;
  border-bottom: 2px solid rgb(200, 200, 245);
}
